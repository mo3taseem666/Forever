...
export const men = products.filter(el => el.category === 'Men');
export const women = products.filter(el => el.category === 'Women');
export const kids = products.filter(el => el.category === 'Kids');

export const Topwear = products.filter(el => el.subCategory === 'Topwear');
export const Bottomwear = products.filter(
   el => el.subCategory === 'Bottomwear'
);
export const Winterwear = products.filter(
   el => el.subCategory === 'Winterwear'
);
